...
const tiers = [
  {
    ...
    howWeHelp:
      "We build performance-first ad campaigns on Meta and Google, paired with SEO and social content strategies that drive consistent, scalable online sales.",
  ...
  },
  {
    ...
    howWeHelp:
      "We design LinkedIn and Google demand-generation campaigns, SEO content that ranks for buyer intent keywords, and conversion-optimised landing pages that turn traffic into pipeline.",
    theme: "bg-brand-navy",
  },
  {
    icon: Building2,
    ...
    howWeHelp:
      "We run precision-targeted paid campaigns with qualification-focused creative and landing pages — generating enquiries from serious buyers, not just form-fillers.",
    theme: "bg-blue-600",
  },
  {
    icon: GraduationCap,
    ...
    howWeHelp:
      "We combine paid campaigns, SEO, and social content to build awareness and drive enrolment at every stage of your admissions cycle.",
    theme: "bg-green-600",
  },
  {
    icon: Heart,
    ...
    howWeHelp:
      "We build trust-first digital strategies — educational content, SEO, and performance campaigns — designed to convert health-conscious audiences at scale.",
    theme: "bg-purple-600",
  },
  {
    icon: Briefcase,
    ...
    howWeHelp:
      "We help startups launch and grow with end-to-end digital marketing — from brand identity and website to paid campaigns and SEO — all strategy-led from day one.",
    theme: "bg-orange-500",
  },
];
...
const IdealAudience = () => {
  return (
    <div className="pt-24">
      {/* ── HERO ── */}
      <section
        className="bg-brand-cream-dark py-32 px-6 relative overflow-hidden text-center"
        aria-label="Who we serve hero"
      >
        ...
        <div className="max-w-4xl mx-auto space-y-8 relative z-10">
          ...
          >
            IS GP MERCATUS
            <br />
            <span className="text-brand-yellow">RIGHT FOR YOU?</span>
          </motion.h1>
          <motion.p
          ...
          >
            We work with businesses globally — from funded startups to
            established brands — across a wide range of industries and markets.
            Here is who we serve best.
          </motion.p>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto space-y-12">
          {tiers.map((tier, idx) => (
            ...
            >
              <div
                className={`lg:w-2/5 p-14 lg:p-20 flex flex-col justify-center text-white relative ${tier.theme}`}
              >
                ...
                <div className="relative z-10 space-y-7">
                  ...
                  <h2 className="text-3xl md:text-4xl font-black leading-none uppercase tracking-tighter">
                    {tier.title}
                  </h2>
              ...
              <div className="lg:w-3/5 p-10 lg:p-20 bg-brand-cream-dark flex flex-col justify-center space-y-10">
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="space-y-6">
                    <h3 className="text-[11px] font-black text-brand-navy/40 uppercase tracking-widest border-b border-brand-navy/10 pb-3">
                      This Fits You If
                    </h3>
                    <ul className="space-y-5">
                      {tier.points.map((point) => (
                        <li
                          key={point}
                          className="flex gap-4 text-brand-navy font-bold text-[17px] leading-snug items-start"
                        >
                          <Zap
                            size={16}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-7 bg-white rounded-3xl border border-brand-navy/5 shadow-sm">
                      ...
                      />
                      <p className="text-sm font-bold text-brand-navy italic leading-relaxed">
                        "{tier.howWeHelp}"
                      </p>
                    </div>
                  </div>
                ...
                <div className="pt-4">
                  <Link
                    to="/contact"
                    className="inline-flex items-center gap-4 text-brand-navy font-black text-base border-b-4 border-brand-yellow pb-2 hover:gap-8 transition-all group"
                  >
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="text-center space-y-5">
            <h2 className="text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-none">
              When We Are
              <br />
              <span className="text-red-400">Not the Right Fit</span>
            </h2>
            <p className="text-xl font-medium text-white/40">
              We would rather be honest upfront than waste your time or budget.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={idx}
                className="flex items-start gap-6 p-9 bg-white/5 rounded-[2.5rem] border border-white/10 group hover:bg-red-500/10 transition-colors"
              >
                ...
                <p className="font-bold text-base text-white/70 leading-tight">
                  {text}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto bg-brand-yellow rounded-[5rem] p-16 lg:p-24 flex flex-col lg:flex-row items-center justify-between gap-16 text-brand-navy relative overflow-hidden">
          ...
          <div className="max-w-2xl space-y-7 relative z-10">
            <h2 className="text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-none">
              See Your Brand
              <br />
              <span className="text-brand-navy/30">Growing Online?</span>
            </h2>
            <p className="text-xl font-bold text-brand-navy/70 leading-relaxed">
              If your business matches any of the segments above, let's talk. We
              will design a custom digital marketing approach tailored to your
              goals, audience, and market.
            </p>
          </div>
          <div className="relative z-10">
            <Button
              size="xl"
              variant="primary"
              className="shadow-2xl shadow-brand-navy/40"
            >

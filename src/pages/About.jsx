...
import {
  ShieldCheck, Zap, Sparkles, Eye, ArrowRight, CheckCircle2,
  Globe, TrendingUp, Users, Award, Target, BarChart3
} from 'lucide-react';
...
const About = () => {
  return (
    <div className="pt-24">
      ...
      <section className="bg-brand-navy py-32 px-6 relative overflow-hidden" aria-label="About hero">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          <div className="lg:w-3/5 space-y-8">
            ...
            >
              WE ARE YOUR<br />DIGITAL GROWTH<br />
          ...
          <div className="lg:w-2/5 space-y-8">
            ...
            >
              GP Mercatus was founded with a clear mission — to bridge the gap between digital marketing potential and real business growth for brands around the world.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      {/* ── STORY ── */}
      <section className="py-32 px-6 bg-white overflow-hidden" aria-label="Our story">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-6 text-base text-brand-navy/60 font-medium leading-relaxed">
              <p>
                GP Mercatus was born out of a frustration shared by many growing businesses: digital marketing agencies that prioritise activity over outcomes — posting calendars over pipeline, vanity metrics over revenue.
              </p>
              <p>
                We built GP Mercatus to be different. We are a full-service digital marketing agency that works with businesses across the world — from ambitious startups to established brands — helping them grow through performance advertising, search engine optimisation, social media, creative strategy, and data analytics.
              </p>
              <p>
                Every service we provide is tied to a business objective. Every campaign we run is measured against results that matter to you — leads, sales, revenue, and growth.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-shrink-0">
            <div className="p-8 bg-brand-navy rounded-3xl text-white space-y-4 min-w-[220px]">
              ...
              <p className="font-black text-lg uppercase">Certified & Trusted</p>
              <p className="text-sm text-white/50">Backed by Admirable Group's excellence and certifications</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── VALUES ── */}
      <section className="py-32 bg-brand-cream-dark px-6" aria-label="Our values">
            ...
            {[
              {
                ...
                color: 'bg-blue-500',
                points: ['Revenue-linked KPIs', 'Full attribution tracking', 'Transparent reporting'],
              },
              {
                icon: Globe,
                ...
                points: ['Multi-market experience', 'Culturally aware strategy', 'Cross-border campaigns'],
              },
              {
                icon: Sparkles,
                ...
                color: 'bg-brand-navy',
                points: ['Conversion-led design', 'A/B tested creatives', 'Brand-consistent execution'],
              },
            ].map((value, idx) => (
              <Card key={idx}>
                <div className="space-y-7">
                  <div className={cn('w-14 h-14 rounded-2xl flex items-center justify-center text-white', value.color)}>
                    <value.icon size={28} />
                  </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-base text-brand-navy/60 font-medium leading-relaxed">
              We do not use your marketing budget as a learning opportunity. Our team brings deep expertise in performance advertising, SEO, social media, and creative strategy — with a track record of results across multiple industries and markets.
            </p>
            <div className="space-y-4">
              {[
                { icon: Target, title: 'Certified Performance Marketing Specialists' },
                { icon: BarChart3, title: 'Analytics & Data Attribution Experts' },
                { icon: Sparkles, title: 'Creative Strategists & Copywriters' },
                { icon: Globe, title: 'Multi-Market Digital Growth Consultants' },
              ].map(stat => (
                <div key={stat.title} className="flex items-center gap-5 p-5 bg-brand-cream rounded-2xl border border-brand-navy/5 group hover:bg-brand-navy hover:text-white transition-all duration-500">
                  ...
                  <p className="text-base font-black uppercase tracking-tighter leading-none">{stat.title}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ── VISION ── */}
      <section className="py-32 bg-brand-navy text-white px-6" aria-label="Our vision">
